...
# More options
ft train --hackathon treehacks-2026 --epochs 2 --batch-size 32 --gradient-accumulation-steps 1 --lr 3e-4 --max-seq-length 16384 --output ./my_adapter
...
HF_TOKEN=<token> HACKATHON=treehacks-2026 EPOCHS=2 BATCH_SIZE=32 GRAD_ACCUM=1 LR=3e-4 MAX_SEQ_LENGTH=16384 docker compose run --rm train
